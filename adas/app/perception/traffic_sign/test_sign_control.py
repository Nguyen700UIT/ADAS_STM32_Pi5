...
-----
  ...
  python -m adas.app.perception.traffic_sign.test_sign_control

  # Custom port:
  python -m adas.app.perception.traffic_sign.test_sign_control --port /dev/ttyUSB0

  # Simulation (no UART):
  python -m adas.app.perception.traffic_sign.test_sign_control --simulate
"""
...
from adas.app.perception.traffic_sign.control import SignController
from adas.app.config import sign_config as cfg
...
def main():
    ...
    if args.simulate:
        ...
        class _FakeUart:
            serial_port = None
            def send_raw_bytes(self, _):
                pass
            def read_raw_bytes(self, _):
                return None
            def close(self):
                pass
